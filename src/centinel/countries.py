...
LATAM_COUNTRIES: Dict[str, CountryPreset] = {
    ...
    "US": CountryPreset(
        ...
        name="Estados Unidos",
        flag="🇺🇸",
        authority="Descentralizado — Secretarios de Estado por entidad (sin autoridad federal unica)",
        divisions_label="Estados",
        divisions=[
            "Alabama",
            "Alaska",
        ...
        national_cne_code="US",
        url_pattern=None,  # No hay feed nacional unico: cada estado publica por su cuenta
        national_url=None,
        result_format=None,  # auto - el formato varia por estado (JSON/CSV/HTML)
        election_interval_seconds=300,
        notes=(
            "Cobertura por estado: EE.UU. no tiene un portal federal unico de "
            "resultados en tiempo real. Cada Secretario de Estado publica por "
            "separado (formatos mixtos JSON/CSV/HTML); el feed rapido agregado "
            "es comercial (AP/Edison). El operador provee la URL por estado."
        ),
    ),
}
