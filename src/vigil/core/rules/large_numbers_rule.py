...
from vigil.core.rules.common import extract_department, safe_int_or_none
from vigil.core.rules.registry import rule
from vigil.core.rules.zscore_unified import (  # noqa: E402 — unified Z-score conventions
    zscore_proportion,
    Z_THRESHOLD_WARNING,
