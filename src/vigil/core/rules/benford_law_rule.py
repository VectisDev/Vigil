...
from vigil.core.rules.benford_unified import benford_canonical, benford_batch
from vigil.core.rules.common import extract_department, extract_candidate_votes
...
def apply(current_data: dict, previous_data: Optional[dict], config: dict) -> List[dict]:
    ...
    from vigil.core.rules.severity import Severity as SeverityEnum  # noqa: PLC0415
