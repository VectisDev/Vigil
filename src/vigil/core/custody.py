...
# ---------------------------------------------------------------------------
# 2. verify_anchor — delegates to vigil.core.anchoring (OTS / Bitcoin)
# ---------------------------------------------------------------------------
...
def verify_anchor(
    ...
    *,
    ...
    For OTS proof verification use: vigil.core.anchoring.verify_ots_proof()
    ...
    # Delegates to: vigil.core.anchoring.verify_ots_proof()
...
def run_startup_verification(
    *,
    ...
    # OTS/Bitcoin anchor verification: use vigil.core.anchoring module.
