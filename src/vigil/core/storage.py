...
# blockchain imports removed — use vigil.core.anchoring instead (Zero Cost)
from vigil.core.hashchain import compute_hash
from vigil.core.models import Snapshot
from vigil.core.normalize import snapshot_to_canonical_json
...
class LocalSnapshotStore:
    ...
    def store_snapshot(self, snapshot: Snapshot, previous_hash: Optional[str] = None) -> str:
        ...
        tx_hash = None  # OTS handles anchoring: vigil.core.anchoring (Zero Cost)
    ...
    def _ensure_department_table(self, table_name: str) -> None:
        ...
        English:
            ...
            Also ensures indexes and extra columns.
        """
        self._assert_safe_identifier(table_name, "table_name")
        self._connection.execute(
            f"""
